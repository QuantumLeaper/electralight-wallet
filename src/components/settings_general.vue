...
<div class="settings-general">
    ...
    <p v-if="config.daemon.type == 'remote'">
        Quick & simple. Less security, wallet will connect to a remote node to make all transactions.
    </p>
    <p v-if="config.daemon.type == 'local_remote'">
        Wallet will download the full blockchain, but use a remote node while syncing.
    </p>
