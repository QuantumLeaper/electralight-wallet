...
<div>
        ...
        <q-popover>
            <q-list separator link>
                ...
                <q-item v-close-overlay @click.native="exit">
                    <q-item-main>
                        <q-item-tile label>Exit  GUI Wallet</q-item-tile>
                    </q-item-main>
                </q-item>
            </q-list>
        </q-popover>
    ...
    <q-modal minimized ref="aboutModal">
        <div class="about-modal">
            ...
            <img class="q-mb-md" src="statics/uplexa-wallet.svg" height="42" />

            <p class="q-my-sm">Version: ElectraLight v{{version}}-v{{daemonVersion}}</p>
            <p class="q-my-sm">Copyright (c) 2018-2019, uPlexa Project</p>
            <p class="q-my-sm">All rights reserved.</p>

            <div class="q-mt-md q-mb-lg external-links">
                <p>
                    <a @click="openExternal('https://uplexa.com/')" href="#">https://uplexa.com/</a>
                </p>
                <p>
                    <a @click="openExternal('https://t.me/uplexaOfficial')" href="#">Telegram</a> -
                    <a @click="openExternal('https://discord.gg/M3yy2H6')" href="#">Discord</a> -
                    <a @click="openExternal('https://www.reddit.com/r/uPlexa/')" href="#">Reddit</a>
                </p>
            </div>
