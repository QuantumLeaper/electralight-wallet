            ...
            <div class="row justify-between" style="max-width: 768px">
                ...
                <div class="infoBox">
                    <div class="infoBoxContent">
                        ...
                        <div class="value"><span><Format :amount="tx.amount" /></span></div>
                    </div>
                </div>
                ...
                <div class="infoBox">
                    <div class="infoBoxContent">
                        ...
                        <div class="value"><span><Format :amount="tx.fee" /></span></div>
                    </div>
                </div>
                    ...
                    <template v-if="out_destinations">
                        <q-item class="q-px-none" v-for="destination in out_destinations">
                            ...
                            <q-item-main>
                                ...
                                <q-item-tile sublabel><Format :amount="destination.amount" /></q-item-tile>
                            </q-item-main>
...
import Format from "components/format_uplexa"
export default {
    name: "TxDetails",
    computed: mapState({
